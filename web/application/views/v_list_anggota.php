...
<div class="container" style="padding-top:90px; height: 650px; width: 900px;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <a href="<?php echo base_url();?>admin/tambah_anggota" class="btn btn-sm btn-primary pull-right">tambah</a>
                    ...
                    <?php if(!empty($anggota)) { ?>
                        <?php foreach($anggota->result() as $data) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url();?>admin/hapus_anggota/<?php echo $data->id; ?>" class="btn btn-sm btn-danger">hapus</a>
                                </td>
