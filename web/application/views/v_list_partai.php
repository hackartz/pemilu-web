...
<div class="container" style="padding-top:90px; height: 650px; width: 800px;">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2 class="panel-title">Daftar Partai</h2>
        </div>
        <div class="panel-body">
            <a href="<?php echo base_url();?>admin/tambah_partai" class="btn btn-sm btn-primary pull-right">tambah</a>
            <br/>
...
<!--                                    <a href="--><?php //echo base_url();?><!--admin/edit_pemilih/--><?php //echo $data->id; ?><!--" class="btn btn-sm btn-info">edit</a>-->
                                    <a href="<?php echo base_url();?>admin/hapus_partai/<?php echo $data->id; ?>" class="btn btn-sm btn-danger">hapus</a>
                                </td>
                            </tr>
                        <?php } ?>
