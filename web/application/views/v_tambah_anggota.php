...
<div class="container" style="padding-top:90px; height: 650px; width: 450px;">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h3 class="panel-title">Tambah Anggota</h3></div>
        <div class="panel-body">
            <form role="form" method="post" action="<?php echo base_url();?>admin/save_anggota" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="border-radius:0px" id="namang" name="namang" placeholder="nama anggota">
                </div>
                <div class="form-group">
                    <label for="partai">partai </label>
                    <select class="form-control" style="border-radius:0px" name="partai">
                        <?php if(!empty($partai)) { ?>
                            <?php foreach($partai->result() as $data) { ?>
                        <option value="<?php echo $data->id;?>"><?php echo $data->nama_partai;?></option>
                            <?php } ?>
                        <?php } ?>
                    </select>
                </div>
