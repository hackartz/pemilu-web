...
<div class="container" style="padding-top:90px; height: 650px; width: 400px;">

    <div class="panel panel-default">
        <div class="panel-heading"><h3 class="panel-title">Tambah Pemilih</h3></div>
        <div class="panel-body">
            <form role="form" method="post" action="<?php echo base_url();?>admin/save_pemilih">
                <div class="form-group">
                    <label for="username">no pemilih </label>
                    <input type="text" class="form-control" style="border-radius:0px" id="nopil" name="nopil" placeholder="no pemilih"
                        value="<?php
                        if(!empty($no_pemilih)) {
                            echo $no_pemilih;
                        }
